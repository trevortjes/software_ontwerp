...
uint8_t drawLine(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2,
	...
	if (t > 1) {
		...
		uint8_t drawTri(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2,
				uint16_t x3, uint16_t y3, uint8_t col, uint16_t fill) {
		...
		uint8_t drawEllip(uint16_t x, uint16_t y, uint16_t xrad, uint16_t yrad,
			...
			while (2.0 * yrad * yrad * xp <= 2.0 * xrad * xrad * yp) {
				if (p < 0) {
					...
					xp++;
					yp--;
					p = p + 2 * yrad * yrad * xp - 2 * xrad * xrad * yp
							- yrad * yrad;
				}
		...
		uint8_t drawEllipFill(uint16_t x, uint16_t y, uint16_t xrad,
				uint16_t yrad, uint8_t col) //met alleen fill
				{
